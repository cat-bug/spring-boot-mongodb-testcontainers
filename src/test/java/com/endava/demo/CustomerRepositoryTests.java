...
public class CustomerRepositoryTests {
    ...
    static {
        GenericContainer mongodb = new GenericContainer("mongo:latest").withExposedPorts(27017);
        mongodb.start();

        System.setProperty("spring.data.mongodb.host", mongodb.getContainerIpAddress());
        System.setProperty("spring.data.mongodb.port", mongodb.getFirstMappedPort().toString());
    }
